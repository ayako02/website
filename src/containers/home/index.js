...
const HomePage = () => {
  return (
    <div className="home-container">
      ...
      <div className="flex flex-column justify-center items-center content">
        <h1 className="white mb0">Ayako</h1>
        <h4 className="white">Front End Developer | UX Designer</h4>

        <div className="flex flex-row items-center">
          <a href="https://github.com/ayako02" title="Github" target="_blank" className="logo dim" rel="noreferrer">
            <svg
              fill="currentColor"
          ...
          <a href="https://www.linkedin.com/in/allison02/" title="LinkedIn" target="_blank" className="logo dim" rel="noreferrer">
            <svg
              fill="currentColor"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 16 16"
          ...
          <a href="https://medium.com/@unicorn-sky" title="Medium" target="_blank" className="logo dim" rel="noreferrer">
            <svg
              fill="currentColor"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 16 16"
          ...
          {/* <a href="https://medium.com/@unicorn-sky" title="Medium" target="_blank" className="logo dim" rel="noreferrer"> */}
          {/* <img alt="behance" src={BehanceLogo} className="logo--img" /> */}
          {/* </a> */}
        </div>
      </div>
    </div>
